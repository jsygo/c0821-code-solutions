...
console.log('delivery date of 3rd most recent order:', orderHistory[2][0].deliveryDate);
console.log('price of the 2nd item of the 4th most recent order:', orderHistory[3][2].price);
console.log('author of 1st item of the most recent order:', orderHistory[0][1].author.lastName + ', ' + orderHistory[0][1].author.firstName);
console.log('author of 1st item of the 3rd most recent order:', orderHistory[2][1].author.lastName + ', ' + orderHistory[2][1].author.firstName);
